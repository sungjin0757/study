...
public class UserDaoV2Test {
    ...
    void setUp(){
        ...
        log.info("userService = {}",this.userDaoV2);
        log.info("this = {} ",this);
    }
    ...
    void 실행_테스트() throws Exception{
        ...
        Assertions.assertThat(userDaoV2.getCount()).isEqualTo(0);

        userDaoV2.add(user1);
        Assertions.assertThat(userDaoV2.getCount()).isEqualTo(1);

        userDaoV2.add(user2);
        Assertions.assertThat(userDaoV2.getCount()).isEqualTo(2);

        userDaoV2.add(user3);
        Assertions.assertThat(userDaoV2.getCount()).isEqualTo(3);

        User findUser1 = userDaoV2.get("1");
        ...
        User findUser2 = userDaoV2.get("2");
        ...
        User findUser3 = userDaoV2.get("3");
