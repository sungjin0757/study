...
public class UserDaoV5Test {
    ...
    void setUp(){
        ...
        log.info("userService = {}",this.userDaoV5);
        log.info("this = {} ",this);
    }
    ...
    void 실행_테스트() throws Exception{
        ...
        Assertions.assertThat(userDaoV5.getCount()).isEqualTo(0);

        userDaoV5.add(user1);
        Assertions.assertThat(userDaoV5.getCount()).isEqualTo(1);

        userDaoV5.add(user2);
        Assertions.assertThat(userDaoV5.getCount()).isEqualTo(2);

        userDaoV5.add(user3);
        Assertions.assertThat(userDaoV5.getCount()).isEqualTo(3);

        User findUser1 = userDaoV5.get("1");
        ...
        User findUser2 = userDaoV5.get("2");
        ...
        User findUser3 = userDaoV5.get("3");
