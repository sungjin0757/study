...
public class UserDaoV7Test {
    ...
    void setUp(){
        ...
        log.info("userService = {}",this.userDaoV6);
        log.info("this = {} ",this);
    }
    ...
    void 실행_테스트() throws Exception{
        ...
        Assertions.assertThat(userDaoV6.getCount()).isEqualTo(0);

        userDaoV6.add(user1);
        Assertions.assertThat(userDaoV6.getCount()).isEqualTo(1);

        userDaoV6.add(user2);
        Assertions.assertThat(userDaoV6.getCount()).isEqualTo(2);

        userDaoV6.add(user3);
        Assertions.assertThat(userDaoV6.getCount()).isEqualTo(3);

        User findUser1 = userDaoV6.get("1");
        ...
        User findUser2 = userDaoV6.get("2");
        ...
        User findUser3 = userDaoV6.get("3");
